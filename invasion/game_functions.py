...
def check_events(my_settings, screen, stats, play_button, ship, aliens, bullets):
	...
	for event in pygame.event.get():
		if event.type == pygame.QUIT:
			...
			check_play_button(my_settings, screen, stats, play_button, ship, aliens,
				bullets, mouse_x, mouse_y)
			
def check_play_button(my_settings, screen, stats, play_button, ship, aliens,
	bullets, mouse_x, mouse_y):
...
def update_screen(my_settings, screen, stats, ship, alien, bullets, play_button):
